...
function fetchJsonWithAuthJWTToken(url, options) {
  return raCore.fetchUtils.fetchJson(url, Object.assign(createOptionsFromJWTToken(), options));
}
...
exports.fetchJsonWithAuthJWTToken = fetchJsonWithAuthJWTToken;
exports.fetchJsonWithAuthToken = fetchJsonWithAuthToken;
exports.getOrderingQuery = getOrderingQuery;
exports.jwtTokenAuthProvider = jwtTokenAuthProvider;
